...
| P2 | [p2-write-path.md](p2-write-path.md) | `/add`, `/update`, `/datasets` (CRUD + graph + raw download + schema), `/ontologies`, `/delete` (deprecated), `/forget`. Multipart streaming. | 3 days | **In Progress** |
