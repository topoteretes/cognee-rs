...
|---|---|---|---|---|
| P0 | [p0-foundation.md](p0-foundation.md) | New `cognee-http-server` crate skeleton, standalone binary, `AppState`, `ApiError`, CORS, OpenAPI bootstrap, root `/`, health router, integration test scaffold. | 1 day | **In Progress** |
