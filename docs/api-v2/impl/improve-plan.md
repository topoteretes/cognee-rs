...
Implemented: yes (Postgres batch edge methods and CLI subcommand deferred per §6)  
Commit: 646ebbc  
Date: 2026-04-24
...
### Step 1 — Extend `GraphDBTrait` with batch feedback-weight methods — [x] done in 646ebbc
...
### Step 2 — Implement the four methods in Ladybug — [x] done in 646ebbc
...
### Step 3 — Add `CheckpointStore` trait and SeaORM backend — [x] done in 646ebbc
...
### Step 4 — Add `get_edges_since()` DB op — [x] done in 646ebbc
...
### Step 5 — Port Stage 1: feedback-weight pipeline — [x] done in 646ebbc
...
### Step 6 — Port Stage 2: persist sessions — [x] done in 646ebbc
...
### Step 7 — Port Stage 4: graph→session sync — [x] done in 646ebbc
...
### Step 8 — Wire stages into `improve()` orchestrator — [x] done in 646ebbc
...
### Step 9 — Re-exports and public API — [x] done in 646ebbc (CLI `improve` subcommand deferred per §6)
...
### Step 10 — Update `CognifyError` / `ApiError` mapping — [x] done in 646ebbc
