...
**13 tasks complete (CLEAN-01, LIB-06, E-01, E-03, E-06, E-07, E-08, LIB-02, LIB-03, LIB-05, LIB-04, LIB-01, LIB-07). Resume point: TASK C-1 (E-04) — Phase B complete; entering Phase C.**

The v2 doc package landed in commits ending `…/docs/http-api-v2/`. The port has **20 tasks** total (Decision 17 added LIB-07). 7 of 20 tasks are at status **Not Started** (1 cleanup + 7 library prerequisites + 5 endpoints done; 7 endpoints remain; CLEAN-01 e146835, LIB-06 b39cd05, E-01 037cad2, E-03 0dafdee, E-06 verified-no-code-change, E-07 35d6b3c, E-08 afa048f, LIB-02 eec6f79, LIB-03 82728f2, LIB-05 60c934a, LIB-04 9f1879e, LIB-01 0818644, LIB-07 7d25c0b).
